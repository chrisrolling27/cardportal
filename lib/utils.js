...
export function endpointFromProxy(url = "") {
  ...
  if (clean.startsWith("/hosted-onboarding")) return "/authe/api/v1/sessions";
  ...
  if (url === "/api/register") return "/lem/v3/legalEntities + /bcl/v2/accountHolders + /bcl/v2/balanceAccounts";
  return clean || url;
}
